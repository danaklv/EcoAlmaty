  ...
  return (
    <Layout>
      <div className="space-y-6">
        ...
        {/* Hero */}
        <div
            className="bg-gradient-forest rounded-2xl px-8 py-6 text-primary-foreground flex items-center justify-between">
          <div>
            ...
            {leagues.map(l => {
              ...
              return (
                  ...
                  >
                    ...
                    <span
                        className={`text-xs mt-0.5 ${isActive ? 'text-green-600 font-medium' : 'text-muted-foreground'}`}>
            ...
            <Card>
              ...
              <CardContent>
                <div className="py-4 text-center text-sm text-muted-foreground">
                  ...
                  <Link to="/challenges" className="mt-2 inline-block">
                    <Button variant="outline" size="sm" className="mt-2">View challenges</Button>
                  </Link>
                </div>
              </CardContent>
            </Card>
              ...
              {achievements.length > 0 ? (
                <div className="grid grid-cols-3 gap-2 mb-4">
                  {achievements.filter(a => a.unlocked).slice(0, 3).map(a => (
                    <div key={a.id} className="bg-muted/40 rounded-xl p-2 text-center">
